...
//+- Массив может быть больше, поэтому придётся использовать цикл, но идея правильная. Попробуй строки с 12 по 18 уложить в массив, используя индекс и размер массива
public class Task5 {
